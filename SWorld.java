...
public class SWorld extends World
{
    ...
    public boolean maxL = false; //determines whether mario is moving left or right
    static boolean maxBig = false; //determines what kind of mario is in the world
    static boolean maxSmall = true; //determines what kind of mario is in the world
